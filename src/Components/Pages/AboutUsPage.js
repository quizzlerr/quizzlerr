...
const aboutUs = () => {
  ...
  <div class="card-body">
    ...
    <button id="showStory" class="btn btn-info AboutUsPage-description-button"> Description </button>
        ...
        <dialog id="Story">
          <form method="dialog">
            <p>Nicolas est le responsable de la base de données. Il a conceptualisé la base de données, l'a remplie et l'a déployée avec Simon. Nicolas a également conçu le backend de la page de classement, ainsi que celui de la fonction permettant de supprimer le compte de l'utilisateur, et a contribué au backend pour la création des quizz
            </p>
            <div class="text-center">
